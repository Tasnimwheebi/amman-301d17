...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT "rando is not a global variable it is inside the function and by using let is a block scope unlike var so if we need to invoke or cosole it we can only invoke it inside it's scope"
  console.log(viewed);
